...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="taller_serviexpress_0._0._1.index" %>
  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul>
        ...
        <li><i class="fa fa-envelope-o"></i> ServiExpres@servexp.com</li>
      </ul>
    </div>
    <div class="fl_right">
      <ul>
  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <div id="logo" class="fl_left">
        <h1><a href="index.html">ServiExpress</a></h1>
      </div>
    ...
    <div class="flexslider basicslider">
      <ul class="slides">
        <li>
          <article>
            <p>Bienvenido a</p>
            <h3 class="heading">ServiExpres</h3>
            <p>Contactanos para cualquier consulta y reservas de hora</p>
            <footer>
              <form class="group" method="post" action="#">
                <fieldset>
                  <legend>Sign-Up:</legend>
                  <input type="email" value="" placeholder="Correo aqui&hellip;">
    ...
    <div id="introblocks">
      <ul class="nospace group">
        <li class="one_third first">
          <article>
            <div>
              <h6 class="heading">Servicio 1</h6>
        ...
        <li class="one_third">
          <article>
            <div>
              <h6 class="heading">Servicio 2</h6>
        ...
        <li class="one_third">
          <article>
            <div>
              <h6 class="heading">SERVICIO 3</h6>
...
<div class="wrapper row4 bgded overlay" style="background-image:url('images/demo/backgrounds/03.png');">
  <footer id="footer" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h3 class="heading">Serviexpress</h3>
    <nav>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2019 - All Rights Reserved - <a href="#"><span class="auto-style1">ServiExpress</span></a></p>
    <!-- ################################################################################################ -->
  </div>
</div>
<!-- ################################################################################################ -->
